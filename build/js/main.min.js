...
var _initNews = require("./modules/news/init-news");
var _initModals = require("./modules/modals/init-modals");
var _initSwiper = require("./modules/swiper/init-swiper");
var _stopSwiper = require("./modules/swiper/stop-swiper");
...
var _burger = require("./modules/header/burger");
var _autoResizeTextarea = require("./modules/textarea/auto-resize-textarea");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initNews.initNews)();
    (0, _initSwiper.initSwiper)();
    (0, _stopSwiper.stopSwiper)();
    (0, _autoResizeTextarea.initAutoResizeTextarea)();
    (0, _map.createMap)();
  });
});
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/header/burger":11,"./modules/map/map":12,"./modules/modals/init-modals":13,"./modules/news/init-news":15,"./modules/select/custom-select":17,"./modules/swiper/init-swiper":19,"./modules/swiper/stop-swiper":20,"./modules/textarea/auto-resize-textarea":21,"./utils/ios-vh-fix":24}],2:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":22,"../../utils/scroll-lock":25}],12:[function(require,module,exports){
"use strict";
...
var getIconOptions = function getIconOptions() {
...
var createMap = function createMap() {
  ...
  }).setView([55.0283865, 82.9276902], 17);
  L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
    maxZoom: 19,
    attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
  }).addTo(map);
  var marker = L.marker([55.0283865, 82.9276902], getIconOptions()).addTo(map);
};
...
},{"../../utils/focus-lock":22,"../../utils/scroll-lock":25}],15:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initNews = void 0;
var items = document.querySelectorAll('.news__slide');
var newsControlsContainer = document.querySelector('.news__controls');
var newsControls = document.querySelectorAll('.news__control');
var swiperContainerNews = document.querySelector('.news__container');
var swiperNews;
var initSwiperNews = function initSwiperNews() {
...
var onNewsButtonClick = function onNewsButtonClick(evt) {
  if (evt.target.closest('.news__control')) {
    var activeButton = evt.target.closest('.news__control');
    if (activeButton.classList.contains('news__control--active')) {
      return;
    } else {
      newsControls.forEach(function (newsControl) {
        return newsControl.classList.remove('news__control--active');
      });
      activeButton.classList.add('news__control--active');
    }
    var filterClass = activeButton.dataset['filter'];
    if (filterClass === 'all') {
      var slides = [];
      items.forEach(function (item) {
        slides.push(item);
      ...
      setTimeout(function () {
        _slides[0].classList.add('news__slide--big');
      }, 400);
    }
    setTimeout(function () {
      swiperNews.update();
...
exports.swiperHero = exports.initSwiper = void 0;
var swiperContainerHero = document.querySelector('.hero__container');
var swiperContainerPrograms = document.querySelector('.programs__container');
var swiperContainerFeedback = document.querySelector('.feedback__container');
var initSwiperHero = function initSwiperHero() {
  var swiperHero = new Swiper(swiperContainerHero, {
    pagination: {
      el: '.hero__pagination',
      type: 'bullets',
...
var swiperHero = initSwiperHero();
exports.swiperHero = swiperHero;
var initSwiper = function initSwiper() {
  var swiperPrograms = new Swiper(swiperContainerPrograms, {
    navigation: {
  ...
  var swipeFeedback = new Swiper(swiperContainerFeedback, {
    navigation: {
...
exports.stopSwiper = void 0;
var _initSwiper = require("./init-swiper");
var _util = require("../../utils/util.js");
var openHeaderbutton = document.querySelector('[data-burger]');
var openModalButton = document.querySelector('[data-open-modal="about"]');
var closeModalElements = document.querySelectorAll('[data-close-modal]');
var closeMenuElements = document.querySelectorAll('[data-close-menu]');
var header = document.querySelector('.main-header');
var onOpenElementClick = function onOpenElementClick(evt) {
  _initSwiper.swiperHero.autoplay.stop();
};
var onBurgerCloseClick = function onBurgerCloseClick() {
  if (!document.body.classList.contains('scroll-lock')) {
    _initSwiper.swiperHero.autoplay.start();
  }
};
var onCloseElementClick = function onCloseElementClick(evt) {
...
var onEscClick = function onEscClick(evt) {
  if (document.body.classList.contains('scroll-lock') && (0, _util.isEscapeKey)(evt)) {
    _initSwiper.swiperHero.autoplay.start();
  }
};
var stopSwiper = function stopSwiper() {
  if (openHeaderbutton) {
...
exports.stopSwiper = stopSwiper;

},{"../../utils/util.js":26,"./init-swiper":19}],21:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resizeHeight = exports.initAutoResizeTextarea = void 0;
var initializedTextAreas = [];
var isResizeEventSet = false;
...
var initAutoResizeTextarea = function initAutoResizeTextarea() {
  var textAreas = document.querySelectorAll('.auto-resize-textarea textarea:not(.is-initialized)');
  if (!textAreas.length) {
    return;
  }
  ...
  if (!isResizeEventSet) {
    ...
    window.addEventListener('resize', function () {
      initializedTextAreas.forEach(function (el) {
        resizeHeight(el);
      });
    });
  }
};
exports.initAutoResizeTextarea = initAutoResizeTextarea;
